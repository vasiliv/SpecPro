    ...
    public partial class Forms : Form
    {
        ...
        private void pr_loadform(object sender, EventArgs e)
        {
            ...
            if (moqme == 2)
            {
                ...
                TC1.AppendText("ყურადღება !!! განცხადებაში მითითებული საწყისი ფასი თუ იგი არ ეფუძნება კრედიტორის მითხოვნის ოდენობას არამედ კრედიტორის მხრიდან ქონების სალიკვიდაციო შეფასებას, ასეთი ფასის განსაზღვრება კრედიტორის მხრიდან პირობითია და რეალიზებული ქონების ფასის სხვაგვარად განსაზღვრის შემთხვევაში იგი არ წარმოშობს რაიმე მოთხოვნას სპეციალისტის ან/და კრედიტორის მიმართ ფასთაშორის სხვაობიდან გამომდინარე." + (char)(13));

                TC1.AppendText("უძრავი ნივთის აღწერა:  " + ow + (char)(13));
                //Task10
                TC1.AppendText("ყურადღება !!!\r\n\r\nაუქციონატორი  (სპეციალისტი) არ არის პასუხისმგებელი სარეალიზაციო ქონების ნივთობრივ მდგომარეობაზე ან/და ფარულ ნაკლზე, ქონების საკუთვნებელზე.\r\n\r\nაუქციონატორი  (სპეციალისტი) არ არის პასუხისმგებელი სარეალიზაციო ქონების უფლებრივ მდგომარეობაზე თუ იგი არ არის რეგისტრირებული საჯარო რეესტრში, ასევე სხვა მესამე პირების მხრიდან შესაძლო დავაზე ახალი მესაკუთრის მამართ.\r\n\r\nაუქციონატორი  (სპეციალისტი) განმარტავს, რომ  წარმოდგენილი ფოტოგამოსახულება მიღებული აქვს კრედიტორისაგან და  იგი შესაძლოა არ შეესაბამება აუქციონის განთავსების მომენტისათვის გასაყიდი ქონების ფაქტობრივ მდგომარეობას. დაინტერესებული პირი ვალდებულია აუქციონში მონაწილეობის მიღებამდე დამოუკიდებლად გადაამოწმოს ქონების ფაქტობრივი მდგომარეობა ყველა ხელმისაწვდომი საჯარო  წყაროებიდან.\r\n\r\nსპეციალისტი არ არის პასუხისმგებელი ახალი მესაკუთრის მიმართ ძველი მესაკუთრის ან სხვა მესამე პირების  გამოსახლებაზე. ან/და მათი მხრიდან სამართლებრივი დავის წამოწყებაზე ან/და უძრავი ქონებით შეუზღუდავად სარგებლობის ხელშეშლაზე. " + (char)(13));
                ...
                else
                {
                    ...
                    //Task10
                    TC1.AppendText("ყურადღება: საჯარო რეესტრში რეგისტრირებული უპირატესი უფლებები ძალაში რჩება და გადახდით არ დაკმაყოფილდება;" + (char)(10) + (char)(13));
            ...
            if (moqme == 4)
            {
                ...
                TC1.AppendText("უძრავი ნივთის აღწერა:  " + ow + (char)(13));
                //Task10                
                TC1.AppendText("ყურადღება !!!\r\n\r\nაუქციონატორი  (სპეციალისტი) არ არის პასუხისმგებელი სარეალიზაციო ქონების ნივთობრივ მდგომარეობაზე, თალსაჩიონო ან/და ფარულ ნაკლზე, ქონების საკუთვნებელზე.\r\n\r\nაუქციონატორი  (სპეციალისტი) არ არის პასუხისმგებელი სარეალიზაციო ქონების უფლებრივ მდგომარეობაზე თუ იგი არ არის რეგისტრირებული საჯარო რეესტრში, ასევე სხვა მესამე პირების მხრიდან შესაძლო დავაზე ახალი მესაკუთრის მამართ.\r\n\r\nაუქციონატორი  (სპეციალისტი) განმარტავს, რომ  წარმოდგენილი ფოტოგამოსახულება მიღებული აქვს კრედიტორისაგან და  იგი შესაძლოა არ შეესაბამება აუქციონის განთავსების მომენტისათვის გასაყიდი ქონების ფაქტობრივ მდგომარეობას. დაინტერესებული პირი ვალდებულია აუქციონში მონაწილეობის მიღებამდე დამოუკიდებლად გადაამოწმოს ქონების ფაქტობრივი მდგომარეობა ყველა ხელმისაწვდომი საჯარო  წყაროებიდან.\r\n\r\nსპეციალისტი არ არის პასუხისმგებელი ახალი მესაკუთრის მიმართ ძველი მესაკუთრის ან სხვა მესამე პირების  გამოსახლებაზე. ან/და მათი მხრიდან სამართლებრივი დავის წამოწყებაზე ან/და უძრავი ქონებით შეუზღუდავად სარგებლობის ხელშეშლაზე. " + (char)(10) + (char)(13));
                TC1.AppendText("გარდამავალი უფლებები:  " + pw + (char)(13));
                TC1.AppendText("აუქციონის პირობები:  " + (char)(13));
                if (cw == "STATIONAR")
                {
            ...
            if (moqme == 6)
            {
                ...
                TC1.AppendText("ყველა პირი, რომელსაც აქვს რაიმე სახის უფლებები უძრავ ქონებაზე, ვალდებულია ამ უფლებათა დამადასტურებელი მტკიცებულებანი წარმოადგინოს აუქციონის დაწყებამდე წერილობითი ფორმით სპეციალისტთან." + (char)(10) + (char)(13));
                //Task10
                TC1.AppendText("ყურადღება: საჯარო რეესტრში რეგისტრირებული უპირატესი უფლებები ძალაში რჩება და გადახდით არ დაკმაყოფილდება;" + (char)(13));
                TC1.AppendText("სპეციალისტი:   შპს ”კონსალტინგ გრუპს”, ს/კ 404483536  " + (char)(13));
                //TC1.AppendText("დირექტორი       ნინო არაბიძე" + (char)(10) + (char)(13));
                //TC1.AppendText("დირექტორი       თამარ მაღალაშვილი" + (char)(10) + (char)(13));
                //Task9
